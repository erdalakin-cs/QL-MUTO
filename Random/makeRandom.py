...
episode_number = 1
drone_number = 5
decreasingValue = 0.0005
listOfDrones = []

totalReward = [0]*episode_number

qTableList = [0]*episode_number
...
if __name__== "__main__":
    ...
    for i in range(1,drone_number+1):
        ...
        fileName = 'qTableDrone'+str(i)+'.csv'
        qTableList[index].to_csv(fileName)
        #print(index)
